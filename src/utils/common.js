...
import { queryAllProperty, accountInfo, accountHistory, latelyHistory } from '@/api/fetch'
import { timeDecorate } from '@/utils/date'
import { isOutIn } from '@/utils/arry'
import { fromByteArray } from 'base64-js'
import bitcoinjs from 'bitcoinjs-lib'
import { arrySplice, handleAmount } from '@/utils/arry'
...
export function myHistory(pointer, account, currentpage, per_page) {
  // const Base64 = require('js-base64').Base64
  // let account = Base64.decode(localStorage.getItem('account'))
